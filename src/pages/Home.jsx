  ...
  return (
    <div className="flex flex-col sm:flex-row">
      <div className="w-full sm:w-1/2">
        ...
        <article className="flex flex-col sm:flex-row m-5 mb-10 gap-5">
        ...
        <article className="flex flex-col-reverse sm:flex-row m-5 mb-10 gap-5">
          <div className="w-full sm:w-1/2">
      ...
      <div className="w-full sm:w-1/2 border">
        <h1 className='text-5xl text-center m-10 mb-10 font-bold underline'>Anuncia tu propiedad aqui!</h1>
      </div>
    </div>
  )
}
