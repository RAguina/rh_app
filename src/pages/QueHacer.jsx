...
function QueHacer() {
  return (
    <div className='min-h-screen'>
      <h1 className='text-3xl mb-20 text-center font-bold'>QueHacer En Necochea?</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <CardQueHacer imagen="/pesca1.jpg" titulo="Pesca de Mar" descripcion="Descripción de la actividad de pesca. adasdasdasdasdasdsadasdasdas" />
