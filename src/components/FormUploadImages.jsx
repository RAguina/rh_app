...
const FormUploadImages = () => {
  ...
  return (
    ...
    <div className='grid'>
     ...
     <button className="navLinks mt-10 w-1/3"
        onClick={saveImages} disabled={mainImage === null || uploadedImages.length === 0}>
        {mainImage ? 'Confirmar' : 'Seleccionar imagen principal'}     
      </button>
     </div>
    </>
  )
